...
const Preferences = {
    ...
    THEMES: {
        ...
        quartz: {
            ...
            sidebarBg: '#f5f0ff',
            sidebarText: '#2e1065',
            sidebarUnreadText: '#1f0a4d',
            sidebarTextHoverBg: '#ede3ff',
            sidebarTextActiveBorder: '#9d4edd',
            sidebarTextActiveColor: '#1f0a4d',
            sidebarHeaderBg: '#e6dbff',
            sidebarHeaderTextColor: '#1f0a4d',
            sidebarTeamBarBg: '#e0d2ff',
            onlineIndicator: '#06d6a0',
            awayIndicator: '#ffd166',
            dndIndicator: '#ef476f',
            mentionBg: '#9d4edd',
            mentionBj: '#9d4edd',
            mentionColor: '#ffffff',
            centerChannelBg: '#ffffff',
            centerChannelColor: '#2a2a2a',
            newMessageSeparator: '#9d4edd',
            linkColor: '#7b2cbf',
            buttonBg: '#9d4edd',
            buttonColor: '#ffffff',
            errorTextColor: '#d90429',
            mentionHighlightBg: '#f1e9ff',
            mentionHighlightLink: '#7b2cbf',
            codeTheme: 'github',
        },
        indigo: {
            type: 'Indigo',
            ...
            sidebarText: '#e0e0e0',
            sidebarUnreadText: '#ffffff',
            sidebarTextHoverBg: '#35224f',
            sidebarTextActiveBorder: '#9d4edd',
            sidebarTextActiveColor: '#ffffff',
            sidebarHeaderBg: '#170e24',
            sidebarHeaderTextColor: '#ffffff',
            sidebarTeamBarBg: '#140a20',
            onlineIndicator: '#06d6a0',
            awayIndicator: '#ffd166',
            dndIndicator: '#ef476f',
            mentionBg: '#9d4edd',
            mentionBj: '#9d4edd',
            mentionColor: '#ffffff',
            centerChannelBg: '#18181b',
            centerChannelColor: '#e0e0e0',
            newMessageSeparator: '#9d4edd',
            linkColor: '#c77dff',
            buttonBg: '#9d4edd',
            buttonColor: '#ffffff',
            errorTextColor: '#ff5d5d',
            mentionHighlightBg: '#35224f',
            mentionHighlightLink: '#e0aaff',
            codeTheme: 'monokai',
        },
        onyx: {
            type: 'Onyx',
